...
Current consolidated API entrypoint:

1. `src/app/api/[[...path]]/route.ts` (dispatches all existing auth, CHPP, matchmaker, team, testing, presence, history, activity, and Forge contracts)
