...
> CHPP `match-event-types` reference.
>
> Event IDs are the stable key. The labels below are kept close to the source text for easy lookup.

## Quick Map

- `19-47` - Match setup and context
- `55-76` - Penalties and extra time
- `80-97` - Captain, set pieces, and injuries
- `100-190` - Home team scoring events
- `200-290` - Home team no-goal mirrors
- `301-311` - Weather and team-state effects
- `331-389` - Tactics and match management
...
### Captain, set pieces, and injuries
...
### Weather and team-state effects
...
These event IDs use non-standard `SubjectPlayerId`, `ObjectPlayerId`, or `SubjectTeamId` mappings.
