      ...
      <header className={styles.header}>
        <div className={styles.headerTop}>
          ...
          <div className={styles.headerActions}>
            ...
            >
              <Lineicons icon={CopyOutlined} size={16} /> Copy Public URL
            </Button>
          </div>
        </div>
                      ...
                      <>
                        {replacingTeamId === team.id ? (
                          ...
                          <Button size="sm" variant="outline" onClick={() => setReplacingTeamId(team.id)}>
                            <Lineicons icon={ReloadOutlined} size={14} /> Replace
                          </Button>
                        )}
                        <button onClick={() => deleteTeam(team.id)} className={styles.deleteBtn}>
                          {isGenerated ? <Lineicons icon={XmarkCircleOutlined} size={20} /> : <Lineicons icon={Trash3Outlined} size={20} />}
                        </button>
                      </>
                    )}
                  </div>
              ...
              {!isGenerated ? (
                ...
                <div className={styles.genActions}>
                  <Button variant="outline" onClick={regenerateSchedule} disabled={isGenerating} fullWidth>
                    <Lineicons icon={ReloadOutlined} size={18} /> Regenerate Schedule
                  </Button>
