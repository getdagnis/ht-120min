...
function reviveInitialTournament(tournament: HomeInitialData['featuredTournaments'][number]): Tournament {
  return {
    ...tournament,
    nextMatchDate: tournament.nextMatchDate ? new Date(tournament.nextMatchDate) : null,
    plannedStartDate: tournament.plannedStartDate ? new Date(tournament.plannedStartDate) : null,
...
export const Home: React.FC<{ initialData?: HomeInitialData }> = ({ initialData }) => {
  ...
  const [activeTournaments, setActiveTournaments] = useState<Tournament[]>(() =>
    (initialData?.activeTournaments || []).map(reviveInitialTournament),
  );
